...
- [`agent-skills-cli`](https://github.com/MauricioPerera/agent-skills-cli) — **reference CLI implementation**. v0.5.0 ships the full agent loop (validate, resolve, sync, query, exec, audit) with intent-conditional rerank as the default — the empirical numbers in the box above were generated by this CLI talking to live Cloudflare Workers AI.
